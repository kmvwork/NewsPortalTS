...
const GroupBtn = (props: GroupBtnProps) => {
  return (
    <div className={`news_item-group-link ${props.sliderClass}`}>
      <a href="#" className="news_item-btn ">
        Read More
      </a>
